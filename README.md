# The 5 Portable Adhan

The 5 Portable Adhan is a well tested and well documented library for calculating Islamic prayer times. The 5 Portable Adhan is written to be compatible with Java and Android devices of all api versions. It compiles against Java 17 to ensure compatibility with Android. It has a small method overhead, and has no external dependencies.
